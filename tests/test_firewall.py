...
class FirewallTests(unittest.TestCase):
    ...
    def test_terraform_contracts_include_secret_header_throttling_and_validation(self):
        ...
        self.assertEqual(outputs.count('python ../scripts/invoke-firewall.py --prompt'), 3)
        ...
        self.assertIn('"X-Amz-Security-Token"', main)
        self.assertIn('authorization_type = "AWS_IAM"', main)
